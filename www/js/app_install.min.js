...
}return offsetParent||docElem})}});jQuery.each({scrollLeft:"pageXOffset",scrollTop:"pageYOffset"},function(method,prop){var top="pageYOffset"===prop;jQuery.fn[method]=function(val){return access(this,function(elem,method,val){var win=getWindow(elem);if(val===undefined){return win?win[prop]:elem[method]}if(win){win.scrollTo(!top?val:window.pageXOffset,top?val:window.pageYOffset)}else{elem[method]=val}},method,val,arguments.length,null)}});jQuery.each(["top","left"],function(i,prop){jQuery.cssHooks[prop]=addGetHookIf(support.pixelPosition,function(elem,computed){if(computed){computed=curCSS(elem,prop);return rnumnonpx.test(computed)?jQuery(elem).position()[prop]+"px":computed}})});jQuery.each({Height:"height",Width:"width"},function(name,type){jQuery.each({padding:"inner"+name,content:type,"":"outer"+name},function(defaultExtra,funcName){jQuery.fn[funcName]=function(margin,value){var chainable=arguments.length&&(defaultExtra||typeof margin!=="boolean"),extra=defaultExtra||(margin===true||value===true?"margin":"border");return access(this,function(elem,type,value){var doc;if(jQuery.isWindow(elem)){return elem.document.documentElement["client"+name]}if(elem.nodeType===9){doc=elem.documentElement;return Math.max(elem.body["scroll"+name],doc["scroll"+name],elem.body["offset"+name],doc["offset"+name],doc["client"+name])}return value===undefined?jQuery.css(elem,type,extra):jQuery.style(elem,type,value,extra)},type,chainable?margin:undefined,chainable,null)}})});jQuery.fn.size=function(){return this.length};jQuery.fn.andSelf=jQuery.fn.addBack;if(typeof define==="function"&&define.amd){define("jquery",[],function(){return jQuery})}var _jQuery=window.jQuery,_$=window.$;jQuery.noConflict=function(deep){if(window.$===jQuery){window.$=_$}if(deep&&window.jQuery===jQuery){window.jQuery=_jQuery}return jQuery};if(typeof noGlobal===strundefined){window.jQuery=window.$=jQuery}return jQuery});(function(){var installedApps={};var install=document.querySelector("button[data-package-manifest-url]");if(install){if(!navigator.mozApps||!navigator.mozApps.installPackage||!navigator.mozApps.getInstalled){document.getElementById("needs-mozapps").classList.remove("hidden")}else{install.classList.remove("hidden");var request=window.navigator.mozApps.getInstalled();request.onerror=function(e){alert("Error calling getInstalled: "+request.error.name)};request.onsuccess=function(e){for(var i=0;i<request.result.length;i++){var manifestURL=request.result[i].manifestURL;installedApps[manifestURL]=request.result[i];$('[data-package-manifest-url="'+manifestURL+'"]').removeClass("install").addClass("launch").text("Launch")}};install.disabled=false;install.addEventListener("click",function f(e){var url=install.getAttribute("data-package-manifest-url");if($(install).hasClass("install")){var request=navigator.mozApps.installPackage(url);request.onsuccess=function(){};request.onerror=function(){alert(this.error.name)}}else if($(install).hasClass("launch")){installedApps[url].launch()}})}}var qel=document.querySelectorAll(".qrcode");for(var i=0;i<qel.length;i++){var installUrl=qel[i].getAttribute("data-qrcode-url");new QRCode(qel[i],installUrl)}})();
//# sourceMappingURL=app_install.min.js.map